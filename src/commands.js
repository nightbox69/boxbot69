<<<<<<< HEAD
<<<<<<< HEAD
import { BROADCASTER } from './oauth.js';

let channelName = BROADCASTER;

=======
>>>>>>> parent of 4d58aa2 (Fix Broadcaster names for centralization, Fix documentation errors, update Notes command)
=======
>>>>>>> parent of 4d58aa2 (Fix Broadcaster names for centralization, Fix documentation errors, update Notes command)
// Important Commands
...
export function gitgud(client) {
  var channel = client.opts.channels[0];
  client.say(channel, 'Oh boss, blame your lack of brain power to speedrunning a very simple game where all resources has been made available to you over to game crashes and bad RNG. PogChamp');
};
